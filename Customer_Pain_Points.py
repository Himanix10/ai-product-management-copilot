...
def render_customer_pain_points():
    ...
    st.caption("Categorize and track recurring friction points across feedback channels")

    col_s1, col_s2 = st.columns([3, 1])
    search_query = col_s1.text_input("Search Pain Points...", placeholder="Filter keywords...")
